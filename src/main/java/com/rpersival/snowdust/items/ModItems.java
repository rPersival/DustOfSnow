...
public class ModItems {
    ...
    public static final Pair<ArmorItem, String> TRUE_ICE_CHESTPLATE = new Pair<>(
            new IceChestplateItem(ModMaterials.TRUE_ICE_ARMOR_MATERIAL, EquipmentSlot.CHEST,
    ...
    public static final Pair<ArmorItem, String> TRUE_ICE_LEGGINS = new Pair<>(
            new IceLegginsItem(ModMaterials.TRUE_ICE_ARMOR_MATERIAL, EquipmentSlot.LEGS,
